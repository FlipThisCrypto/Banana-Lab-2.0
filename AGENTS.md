# Instructions for agents working in Banana Lab 2.0

Read this before touching anything. `CLAUDE.md` is a symlink-equivalent of this
file; both say the same thing.
